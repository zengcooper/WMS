 ...
 *
 * Author: Cooper
 * Create Date: 2018-12-28 14:42:04
 *
 * Description: Git.Framework
 * 
 * Revision History:
 * Date         Author               Description
 * 2018-12-28 14:42:04       Cooper
*********************************************************************************/
    ...
    public partial class LocationProvider : DataFactory
    {
        ...
        public List<LocationEntity> GetList()
        {
            ...
            if (!listResult.IsNullOrEmpty())
            {
                ...
                //netcore不支持sysweb，cache只用2个参数的函数,后期注意库位变更到期时间
                CacheHelper.Insert(CacheKey.JOOSHOW_LOCATION_CACHE, listResult);
            }
            return listResult;
        }
